...
import static org.example.order.lifecycle.processor.utils.TestUtils.createJsonSerde;
...
public class FillOrderStreamTest {
    ...
    public void setUp() {
        ...
        fillOrderStream = new FillOrderStream(
                ...
                createJsonSerde(VerificationRecord.class),
        ...
        fillOrderStream.verificationTopic = "test-verification-topic";
